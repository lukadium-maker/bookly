      ...
      <div className="screen" dir="rtl">
        <div className="header">
          <label className="avatar-upload-wrap" htmlFor="avatar-input" style={{cursor:'pointer'}}>
            ...
            <div className="avatar-edit-badge">{uploading ? '...' : <PenLine size={11} />}</div>
          </label>
          <input
            id="avatar-input"
            type="file"
        ...
        {todayApts.length === 0 && (
          <div className="empty-state">
            <div className="empty-icon"><Hospital size={40} color="rgba(255,255,255,0.2)" /></div>
        ...
        <div className="owner-menu">
          <button className="menu-btn" onClick={() => setScreen('appointments')}>
            <span style={{display:'flex',alignItems:'center'}}><CalendarDays size={18} color='#C9A84C' /></span>
          ...
          <button className="menu-btn" onClick={() => setScreen('manageSlots')}>
            <span style={{display:'flex',alignItems:'center'}}><Ban size={18} color='#ff6b6b' /></span>
            <span>مسدود کردن ساعات</span>
          </button>
          <button className="menu-btn" onClick={() => setScreen('share')}>
            <span style={{display:'flex',alignItems:'center'}}><Link2 size={18} color='#60a5fa' /></span>
        ...
        <div className="share-card">
          ...
          }}><ClipboardCopy size={15} style={{marginLeft:"6px",verticalAlign:"middle"}} /> کپی لینک</button>
        </div>
      ...
      <div className="screen" dir="rtl">
        ...
        <div className="share-card">
          ...
          <button className="copy-btn" onClick={() => {
            ...
            alert('کپی شد!')
          }}><ClipboardCopy size={15} style={{marginLeft:"6px",verticalAlign:"middle"}} /> کپی</button>
        </div>
  ...
  if (screen === 'editBusiness') {
    ...
    return (
      <div className="screen" dir="rtl">
        ...
        <div className="header">
          <div className="business-avatar" style={{background:"linear-gradient(135deg,#C9A84C,#E8C97A)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"20px",fontWeight:"900",color:"#1A0003"}}>{businessName ? businessName.charAt(0) : "B"}</div>
